 ...
 */
CKEDITOR.plugins.add("pb-base64image-for-ckedtor", {
    ...
    init	: 	function(editor){
					var pluginName = 'pb-base64image-for-ckedtorDialog';
					...
					if(editor.addMenuItem) {
						...
						editor.addMenuItem("base64imageItem", {
							label: editor.lang.common.image,
							icon: this.path+"icons/pb-base64image-for-ckedtor.png",
							command: pluginName,
							group: "pb-base64image-for-ckedtorGroup"
						});
					}
